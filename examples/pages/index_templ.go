...
func howItWorksSection() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "<div class=\"container\" style=\"margin-top: 30px;\"><h2>How It Works</h2><p>Each component above is registered in the Go component registry with type-safe form binding and HTMX header handling:</p><ol><li>Forms submit to <code>/component/")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
